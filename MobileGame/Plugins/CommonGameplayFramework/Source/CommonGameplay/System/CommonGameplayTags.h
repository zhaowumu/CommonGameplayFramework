...
#pragma region UI
	...
	COMMONGAMEPLAY_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Fei_UI_Layer_HUD);
	COMMONGAMEPLAY_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Fei_UI_Layer_Game);
	// COMMONGAMEPLAY_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Fei_UI_Layer_Desktop);
	// COMMONGAMEPLAY_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Fei_UI_Layer_Window);
	COMMONGAMEPLAY_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Fei_UI_Layer_Panel);
	COMMONGAMEPLAY_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Fei_UI_Layer_Modal);
	COMMONGAMEPLAY_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Fei_UI_Layer_Tips);
