...
public:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, meta=(BindWidget))
	UCommonActivatableWidgetStack* Panel_Stack;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, meta=(BindWidget))
	UCommonActivatableWidgetStack* Modal_Stack;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, meta=(BindWidget))
	UOverlay* Tips_Overlay;
...
public:
	...
	TArray<UCommonActivatableWidget*> FindCommonActivatableWidgetByClass(
		TSubclassOf<UCommonActivatableWidget> WidgetClass);

	void RemoveCommonActivatableWidgetByClass(TSubclassOf<UCommonActivatableWidget> ActivatableWidget);

	void RemoveDesktopWidget(TSubclassOf<UCommonDesktop> DesktopWidget);

	void RemovePanelWidget(TSubclassOf<UCommonPanel> PanelWidget);

	void PopPanelWidget() const;

	DECLARE_DYNAMIC_DELEGATE_OneParam(FOnPanelWidgetAdded, UCommonActivatableWidget*, CommonWidget);

	void AddPanelWithFunc(TSubclassOf<UCommonPanel> PanelWidget, FOnPanelWidgetAdded Func);
